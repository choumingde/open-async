...
//        testMulti9();
    ...
    private static void testNormal() throws InterruptedException, ExecutionException {
        ...
        Async.beginWork(1500,COMMON_POOL, workerWrapper, workerWrapper1, workerWrapper2);
//        Async.beginWork(800,COMMON_POOL, workerWrapper, workerWrapper1, workerWrapper2);
//        Async.beginWork(1000,COMMON_POOL, workerWrapper, workerWrapper1, workerWrapper2);

        System.out.println("end-" + SystemClock.now());
        System.err.println("cost-" + (SystemClock.now() - now));
        System.out.println(workerWrapper.getWorkResult());
        Async.getThreadCount(COMMON_POOL);
    ...
    private static void testMulti() throws ExecutionException, InterruptedException {
        ...
        Async.beginWork(2500,COMMON_POOL, workerWrapper, workerWrapper2);
    ...
    private static void testMultiError() throws ExecutionException, InterruptedException {
        ...
        Async.beginWork(1500,COMMON_POOL, workerWrapper, workerWrapper2);
    ...
    private static void testMulti3() throws ExecutionException, InterruptedException {
        ...
        Async.beginWork(3100,COMMON_POOL, workerWrapper);
...
//        Async.beginWork(2100, workerWrapper);
    ...
    private static void testMulti4() throws ExecutionException, InterruptedException {
        ...
        //正常完毕
        Async.beginWork(4100,COMMON_POOL, workerWrapper);
        //3会超时
...
//        Async.beginWork(2900, workerWrapper);
    ...
    private static void testMulti6() throws ExecutionException, InterruptedException {
        ...
        //正常完毕
        Async.beginWork(4100,COMMON_POOL, workerWrapper0);
    ...
    private static void testMulti7() throws ExecutionException, InterruptedException {
        ...
        //正常完毕
        Async.beginWork(4100,COMMON_POOL, workerWrapper00, workerWrapper0);
    ...
    private static void testMulti8() throws ExecutionException, InterruptedException {
        ...
        Async.beginWork(6000,COMMON_POOL,workerWrappera1, workerWrappera2);
        System.err.println(Async.getThreadCount(COMMON_POOL));
    }
...
//        w1.setSleepTime(1100);
        ...
        Async.beginWork(6000,COMMON_POOL, wrapperW, wrapperW1);
        System.err.println(Async.getThreadCount(COMMON_POOL));
    }
